...
def login():
    ...
    if (len(r) > 0):
        ...
        l1 = Label(mg, text="INVALID LOGIN", font=("Tw Cen MT", 15), fg="RED", bg="#181D31", padx=12, pady=5).place(
            x=160, y=540)

def goback():
    mg.destroy()
    
mg = Tk()  # Use Tk() instead of Toplevel()
mg.maxsize(500, 720)
mg.minsize(500, 720)
...
Label(mg, text="Log in as Manager", font=("Tw Cen MT", 25, "bold"), fg="#E6DDC4", bg="#181D31", padx=12,
      pady=5).place(x=120, y=270)
...
passw = Entry(mg, width=25, fg="#F0E9D2", border=0, bg="#181D31", font=("Ariel", 12), show="*")
...
sub_button = Button(mg, text="Submit", font=("Tw Cen MT", 15, "bold"), fg="#F0E9D2", bg="#678983",
                    activebackground="#678983", activeforeground="#F0E9D2", relief=GROOVE, command=login)
