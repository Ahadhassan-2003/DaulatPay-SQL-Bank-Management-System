...
import 'package:bank_management_system/presentation/currency_settings_bottomsheet/currency_settings_bottomsheet.dart';
import 'package:bank_management_system/presentation/map_location_bottomsheet/map_location_bottomsheet.dart';
...
class AppNavigationScreen extends StatelessWidget {
                                ...
                                child: Container(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                              onTap: () {
                                                onTapMinePageContainer(context);
                                              },
                                              child: Container(
                                                  decoration: AppDecoration
                                                      .fillWhiteA700,
  ...
  onTapMinePageContainer(BuildContext context) {
    NavigatorService.pushNamed(
  ...
  onTapCardSettings(BuildContext context) {
  ...
  onTapCurrencySettings(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (_) => CurrencySettingsBottomsheet.builder(context),
        isScrollControlled: true);
  }
